...
请遵循以下格式：
- [ ] **name**：提供描述您添加的资源或数据的简短标题。
- [ ] **description**：清楚地说明添加了什么资源或数据以及属于哪个类别。
- [ ] **url**：提供资源的 url。
- [ ] **category**：提供资源的类别。
- [ ] **tags**：提供资源的几个标签。（最多 3 个标签）
- [ ] **icon_url**：提供资源图标的 url。（可选）如果未提供，图标将自动生成。


### 附加说明
- **仅限开发者资源**：请不要提交与开发无关的资源。
- **不允许联盟链接**：不要包含联盟链接。
- **禁止垃圾信息**：不要包含垃圾信息。
- **可访问的 URL**：确保 url 可访问。
...
## 使用
### 手动
- 资源：更改 `data/json/[locale]` 文件夹中的 jsonc 文件。
